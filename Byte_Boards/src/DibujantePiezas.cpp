...
void DibujantePiezas::dibujarPeonCiencias(int fila, int columna,float tam) {
...
void DibujantePiezas::dibujarTorreCiencias(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarCaballoCiencias(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarAlfilCiencias(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarReyCiencias(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarReinaCiencias(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarPeonLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarTorreLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarCaballoLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarAlfilLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarReyLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
...
void DibujantePiezas::dibujarReinaLetras(int fila, int columna, float tam) {
	float offsetX = -((tablero.ver_ancho() * tam) / 2.0f);
	float offsetZ = -((tablero.ver_largo() * tam) / 2.0f);
