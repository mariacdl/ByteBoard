...
Tablero Configuracion::genTablero(char modalidad){
    if(modalidad=='P'){
		...
		tab.colocar_pieza(0,5,'T','B');
		tab.colocar_pieza(1,5,'C','B');
		tab.colocar_pieza(2,5,'A','B');
		tab.colocar_pieza(3,5,'R','B');
		tab.colocar_pieza(4,5,'D','B');
		tab.colocar_pieza(0,4,'P','B');
		tab.colocar_pieza(1,4,'P','B');
		tab.colocar_pieza(2,4,'P','B');
		tab.colocar_pieza(3,4,'P','B');
		tab.colocar_pieza(4,4,'P','B');
